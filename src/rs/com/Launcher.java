...
public class Launcher {
	...
	public static String bonusSkill;
	public static final String[] SKILL_NAME = { "Attack", "Defence", "Strength", "Constitution", "Ranging", "Prayer", "Magic", "Cooking", 
	"Woodcutting", "Fletching", "Fishing", "Firemaking", "Crafting", "Smithing", "Mining", "Herblore", "Agility", "Thieving", "Slayer", 
	"Farming", "Runecrafting", "Hunter", "Construction", "Summoning" };
	
	public static String getBonusSkill() {
		return bonusSkill;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		// return;
		// }
		bonusSkill = SKILL_NAME[Utils.random(SKILL_NAME.length)];
		Logger.log("Launcher", "Bonus Skill was set to: "+bonusSkill+"");
		Logger.log("Launcher", "Server took " + (Utils.currentTimeMillis() - currentTime) + " milli seconds to launch.");
		addFilesSavingTask();
		addCleanMemoryTask();
		addrecalcPricesTask();
		Logger.log("Launcher", "Textures: " + (Utils.getTextureSize()) + ".");
	}
