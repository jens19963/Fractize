...
public final class Settings {
	 ...
	 */
	public static final String SERVER_NAME = "Fractize";
	public static final String HOST = "127.0.0.1";
	public static final int PORT_ID = 43594;
	public static final String LASTEST_UPDATE = "<col=7E2217>Lastest Update: Boss Pets";
	...
	public static final WorldTile START_PLAYER_LOCATION = new WorldTile(3087, 3491, 0);
	...
	public static final String[] ADMINISTRATORS = new String[] { "jens" };
