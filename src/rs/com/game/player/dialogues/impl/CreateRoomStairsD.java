...
public class CreateRoomStairsD extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		if (stage == -1) {
			...
			Builds stair = room.getPlane() == 1 && !up && componentId == OPTION_3 ? Builds.STAIRCASE_2 : componentId == OPTION_2 ? up ? Builds.STAIRCASE_DOWN_1 : Builds.STAIRCASE_1 : up ? Builds.STAIRCASE_DOWN : Builds.STAIRCASE;
