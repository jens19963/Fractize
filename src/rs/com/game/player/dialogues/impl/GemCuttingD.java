...
public class GemCuttingD extends Dialogue {
	...
	public void start() {
		...
		SkillsDialogue.sendSkillsDialogue(player, SkillsDialogue.CUT, "How many do you wish to make?", player.getInventory().getItems().getNumberOf(gem.getUncut()), new int[] { gem.getUncut() }, null);
