...
public class GodWars extends Controller {
	...
	public static final WorldTile[] GODS = { new WorldTile(2863, 5357, 0), new WorldTile(2862, 5357, 0), // bandos
	...
	public void sendInterfaces() {
		sendInterfaces(player.withinArea(2916, 5317, 2937, 5332) ? 2 : inZamorakPrepare(player) ? 1 : 0);
	}
	...
	public boolean processObjectClick1(final WorldObject object) {
		if (object.getId() == 57225) {
			...
			boolean returning = player.withinArea(2819, 5295, 2839, 5309) || player.withinArea(2863, 5352, 2878, 5375) || player.withinArea(2916, 5317, 2937, 5332) || player.withinArea(2915, 5242, 2931, 5256);
	...
	public void sendInterfaces(int interfaceIndex) {
		player.getInterfaceManager().setOverlay(INTERFACES[interfaceIndex], true);
		refresh();
	}
