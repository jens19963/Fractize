...
public class InterfaceManager {
	...
	public static String getTime() {
		long l = Utils.currentTimeMillis() - Launcher.currentTime;
	...
	public void sendPanel() {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + Tab.QUEST : FIXED_TAB_OFFSET + Tab.QUEST, 905);
		player.getPackets().sendIComponentText(905, 5, "Time: <col=00ff00>"+ Utils.getDateTime() +"");
		player.getPackets().sendIComponentText(905, 7, "Uptime: <col=00ff00>"+ getTime());
		player.getPackets().sendIComponentText(905, 8, "Players Online: <col=00ff00>" + World.getPlayers().size() + "");
		player.getPackets().sendIComponentText(905, 9, "Bonus Skill: <col=00ff00>"+ Launcher.getBonusSkill());
		player.getPackets().sendIComponentText(905, 12, "Mode: <col=00ff00>Normal");
		player.getPackets().sendIComponentText(905, 13, "Rank: <col=00ff00>"+ player.getRank() +"");
		player.getPackets().sendIComponentText(905, 14, "Playtime: <col=00ff00>"+ player.ptime() +"");
		if (player.isXpLocked() == true) {
		player.getPackets().sendIComponentText(905, 15, "XP Locked: <col=db0000>True");
		} else {
		player.getPackets().sendIComponentText(905, 15, "XP Locked: <col=db0000>False");
		}
		player.getPackets().sendIComponentText(905, 16, "Bonus XP Timer: <col=db0000>todo");
		if (player.getSlayerManager().getCurrentTask() != null) {
		player.getPackets().sendIComponentText(905, 17, "Task: <col=db0000>"+ player.getSlayerManager().getCurrentTask().getName() +"");
		} else {
		player.getPackets().sendIComponentText(905, 17, "Task: <col=db0000>None");
		}
	...
	public void sendQuestList() {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + Tab.QUEST : FIXED_TAB_OFFSET + Tab.QUEST, 906);
	}
