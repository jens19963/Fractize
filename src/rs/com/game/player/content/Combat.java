			...
			if (shieldId == -1 || (shieldName.contains("book") && shieldId != 18346)) {
				...
				if (weaponName != null && !weaponName.equals("null")) {
					...
					if (weaponName.contains("staff of light"))
						return 12806;
					if (weaponName.contains("longsword") || weaponName.contains("darklight") || weaponName.contains("scimitar") || weaponName.contains("silverlight") || weaponName.contains("excalibur"))
						return 388;
