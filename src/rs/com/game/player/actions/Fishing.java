...
public class Fishing extends Action {
	...
	public enum FishingSpots {
		...
		NET(327, 1, 303, -1, new Animation(621), Fish.SHRIMP, Fish.ANCHOVIES), LURE(328, 1, 309, 314, new Animation(622), Fish.TROUT, Fish.SALMON), LURE2(329, 1, 309, 314, new Animation(622), Fish.TROUT, Fish.SALMON), LURE3(317, 1, 309, 314, new Animation(622), Fish.TROUT, Fish.SALMON),

		BAIT(328, 2, 307, 313, new Animation(622), Fish.PIKE),

		BAIT2(317, 2, 307, 313, new Animation(622), Fish.PIKE), BAIT3(329, 2, 307, 313, new Animation(622), Fish.PIKE),
