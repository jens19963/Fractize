		...
		player.setRouteEvent(new RouteEvent(npc, new Runnable() {
			...
			public void run() {
				...
				if (shipAttributes != null) {
					...
					player.getSocialManager().sendMessage(99, "Pet [id=" + pet.getId() + ", hunger=" + pet.getDetails().getHunger() + ", growth=" + pet.getDetails().getGrowth() + ", stage=" + pet.getDetails().getStage() + "].", player);
				} else {
