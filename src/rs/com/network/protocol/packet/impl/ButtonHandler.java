...
import com.rs.game.player.content.interfaces.Teleports;
...
public class ButtonHandler {
	...
	public static void handleButtons(final Player player, InputStream stream, final int packetId) {
		...
		int slotId2 = stream.readShortLE();
		...
		} else if (interfaceId == 905 && componentId == 18) {
			player.getInterfaceManager().sendQuestList();
		} else if (interfaceId == 906 && componentId == 6) {
			player.getInterfaceManager().sendPanel();
